...
Original file is located at
    https://colab.research.google.com/drive/1R5K4YGnuydExBdhzB47FT3nIMwuHAXXA
"""
...
class baseNet(nn.Module):
    def __init__(self):
        ...
        # 3 channels for RGB), 32 output channels, 5x5 square convolution
        # kernel
...
optimizer = optim.SGD(net.parameters(), lr=0.001, momentum=0.5) #0.0001, 0.7 --> 68%
